 ...
 * be removed.</li>
 * <li>If a {@link org.springframework.security.web.savedrequest.SavedRequest}
 * is found in the {@code RequestCache} (as set by the
 ...
 * cached and be picked up when the redirected request is received (See <a href=
 * "{@docRoot}/org/springframework/security/web/savedrequest/SavedRequestAwareWrapper.html"
 * >SavedRequestAwareWrapper</a>).</li>
 * <li>If no {@link org.springframework.security.web.savedrequest.SavedRequest}
 * is found, it will delegate to the base class.</li>
 * </ul>
 *
 * @author Luke Taylor
 * @since 3.0
